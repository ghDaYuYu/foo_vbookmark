...
#define COMPONENT_VERSION_PATCH 26
...
#else
#ifdef BETA_VER
#define MAKE_COMPONENT_VERSION(major,minor,patch,subpatch) MAKE_STRING(major) "." MAKE_STRING(minor) "." MAKE_STRING(patch) "." MAKE_STRING(subpatch) " alpha"
#else
